...
const DashboardAssistant = () => {
    ...
    return (
      <div className="fixed bottom-6 right-6 z-50">
        <Button 
          ...
          className="bg-primary text-white p-3 rounded-full hover:bg-primary/90 shadow-lg flex items-center justify-center"
        >
  ...
  return (
    <Card className={`${isExpanded ? 'fixed inset-4 z-50' : 'w-full'} transition-all duration-300 overflow-hidden bg-card border shadow-md`}>
      ...
      <CardContent className={`p-4 ${isExpanded ? 'h-[calc(100%-13rem)]' : 'max-h-[250px]'} overflow-y-auto`}>
        <div className="space-y-4">
          {messages.map((message, index) => (
            ...
            >
              ...
              <div
                className={`rounded-lg py-2 px-3 max-w-[90%] ${
                  message.role === "assistant"
